...
- the system CAD dimension tool selects geometry before placement, previews the inferred measurement, persists its canvas position, and supports line length, arc radius or diameter, point alignment, line angle or offset, and tangent-aware arc distances for later editing
