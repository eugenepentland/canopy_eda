...
- the PCB DRC panel offers an undoable whole-board recheck that recuts every adaptive run against its current exact clearance without moving its centre line, while fixed-width copper remains untouched
