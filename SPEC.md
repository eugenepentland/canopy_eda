...
- While hand-routing, one live ratsnest line follows the legal preview endpoint to the closest unresolved destination, including when routing resumes from existing copper.
