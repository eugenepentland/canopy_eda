...
(footprint "pin-header-1x4-2-54mm"
  (description "Through-hole 1x4 pin header, 2.54 mm (0.1 in) pitch, single row")
  ...
  (courtyard (rect -1.270 -1.270 1.270 8.890))
  (silkscreen
    (line (-1.27 -1.27) (1.27 -1.27))
    (line (1.27 -1.27) (1.27 8.89))
    (line (1.27 8.89) (-1.27 8.89))
    (line (-1.27 8.89) (-1.27 -1.27))
  )
)
