...
pub fn build(b: *std.Build) !void {
...

    {
        ...
        const tests = b.addTest(.{
            ...
            // The exact upstream package omits its declared test runner. Reuse
            // httpz's equivalent serial setup/teardown runner in this vendored
            // dependency graph so the shared test server has a defined lifetime.
