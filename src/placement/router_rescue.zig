...
const directSegmentInside = router.directSegmentInside;
const directViaClear = router.directViaClear;
const direct_probe_budget = router.direct_probe_budget;
const emitDoglegSegment = router.emitDoglegSegment;
const fine_grid_scale = router.fine_grid_scale;
const hardGuidedPolicy = router.hardGuidedPolicy;
const immediate_fine_probe_budget = router.immediate_fine_probe_budget;
...
const restoreNetOcc = router.restoreNetOcc;
const ripNet = router.ripNet;
...
const shrinkCopper = router.shrinkCopper;
const smoothNetInline = router.smoothNetInline;
const tryDirectDogleg = router.tryDirectDogleg;
