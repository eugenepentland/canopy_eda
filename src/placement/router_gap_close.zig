...
const emitShapeRoute = router_rescue.emitShapeRoute;
...
const shapeFirst = router_rescue.shapeFirst;
const shape_first_hop_mm = router_rescue.shape_first_hop_mm;
const shapeInput = router_rescue.shapeInput;
const shapeRefusal = router_rescue.shapeRefusal;
