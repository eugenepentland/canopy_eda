...
/// The `(instance …)` body sub-forms this parser dispatches on. Any other
/// head falls through to the inline-property branch, so this list is also
/// half of the vocabulary a typo is measured against.
