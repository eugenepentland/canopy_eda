...
test "home design cards wire the compact layout-progress endpoint" {
    const template = @embedFile("templates/pages.zig");
...
test "primary web pages expose a consistent phone layout" {
    ...
    const home = @embedFile("templates/pages.zig");
    ...
    const library_template_source = @embedFile("templates/library.zig");
