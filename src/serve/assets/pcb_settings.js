...
function render(){var fn={overview:overview,stackup:stackup,rules:rules,"net-classes":netClasses,"diff-pairs":diffPairs,"routing-plan":routingPlan,"drc-policy":drcPolicy,source:source};body.innerHTML=(fn[current]||overview)();wireSearch();wireStackupPreset();wireRuleEditor();wireDrcPolicy();body.scrollTop=0;}
...
function stackup(){var st=stackRows(),spec=meta.stackup||{},auth=spec.authored,preset=spec.preset||"";var h=title("Stackup","The complete physical construction is shown top-to-bottom. Copper electrical roles remain independent from foil and dielectric fabrication details.");
...
function rules(){var eff=PCB.rules||{},raw=meta.design_rules||{};var rows=[
 ...
 ["Component-to-edge","component_edge","Minimum space from a component courtyard to the finished board outline; defaults to JLCPCB Standard PCBA's 2.5 mm body clearance."],
...
function netClasses(){var groups=classGroups(),h=title("Net classes","Search by class or net. Expand a class to inspect its effective geometry and click a member net to highlight it on the board.");h+='<input class="ds-search" id="ds-class-search" type="search" placeholder="Filter classes or nets…" aria-label="Filter net classes"><div id="ds-class-list">';
...
var DRC_HELP={
 ...
 component_edge:"A component courtyard sits closer to the finished board edge than the assembly rule. The 2.5 mm default follows JLCPCB Standard PCBA's component-body requirement.",
